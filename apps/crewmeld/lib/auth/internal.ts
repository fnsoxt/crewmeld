...
const JWT_ISSUER = 'crewmeld-internal'
const JWT_AUDIENCE = 'crewmeld-api'
// Legacy iss/aud kept for dual-accept verification during migration window
// from the upstream fork rename. Safe to drop once all in-flight tokens
// signed before the rename have expired (max JWT TTL is 5m, see below).
const LEGACY_JWT_ISSUER = 'crewmeld-internal'
const LEGACY_JWT_AUDIENCE = 'crewmeld-api'
