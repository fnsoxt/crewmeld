Crewmeld
Copyright 2026 Beijing Proinsight Technology Co., Ltd.

(Chinese translation: see NOTICE.zh-CN.md)

This product is licensed under a modified version of the Apache License 2.0.
See LICENSE for full terms.

This distribution includes third-party open-source code vendored from the
following upstream projects:

  - shadcn/ui                  MIT     https://ui.shadcn.com
  - react-email                MIT     https://react.email
  - better-auth                MIT     https://better-auth.com
