...
export const defaultMockEnv = {
  ...
  BETTER_AUTH_URL: 'https://test.crewmeld.test',
  ...
  FROM_EMAIL_ADDRESS: 'CrewMeld <noreply@test.crewmeld.test>',
  EMAIL_DOMAIN: 'test.crewmeld.test',
  PERSONAL_EMAIL_FROM: 'Test <test@test.crewmeld.test>',
