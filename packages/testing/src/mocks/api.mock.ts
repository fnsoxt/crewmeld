 ...
 * ```ts
 * mockCommonSchemas()
 * // Now @crewmeld/db/schema exports are mocked
 * ```
 */
export function mockCommonSchemas() {
  vi.doMock('@crewmeld/db/schema', () => ({
    workflowFolder: {
      id: 'id',
      userId: 'userId',
      parentId: 'parentId',
 ...
 * ```ts
 * mockConsoleLogger()
 * // Now @crewmeld/logger.createLogger returns a mock logger
 * ```
 */
export function mockConsoleLogger() {
  const mockLogger = createMockLogger()
  vi.doMock('@crewmeld/logger', () => ({
 ...
 * // Now @crewmeld/db/schema exports knowledge base tables
 * ```
 */
