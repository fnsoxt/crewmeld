 ...
 * @example
 * ```ts
 * import { createMockLogger, setupGlobalFetchMock, databaseMock } from '@crewmeld/testing/mocks'
 *
 * // Mock the logger
 * vi.mock('@crewmeld/logger', () => ({ createLogger: () => createMockLogger() }))
 *
 * // Mock fetch globally
 * setupGlobalFetchMock({ json: { success: true } })
 *
 * // Mock database
 * vi.mock('@crewmeld/db', () => databaseMock)
 * ```
 */
...
// Executor mocks - use side-effect import: import '@crewmeld/testing/mocks/executor'
// Fetch mocks
export {
  createMockFetch,
  createMockResponse,
