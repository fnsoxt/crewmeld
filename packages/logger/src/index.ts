 ...
 * @crewmeld/logger
 *
 * Framework-agnostic logging utilities for the CrewMeld platform.
...
export class Logger {
  ...
  private shouldLog(level: LogLevel): boolean {
    ...
    // Runtime check for browser environment — window is intentionally not in TS lib
    // because this package is used from both Node (server) and bundled browser code.
    if (
